...
namespace QueryRunner.Models
  {
  public class EditTestAndQuestionsViewModel
    {
      ...
      public EditTestAndQuestionsViewModel() {}
      public EditTestAndQuestionsViewModel(ModelTest model) { _model = model; }  
      public EditTestAndQuestionsViewModel(ModelTest model, List<ModelQuestion> questions)
      {
          _model = model;
          Questions = questions;
      }
